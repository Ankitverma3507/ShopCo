      ...
      <div className=" flex h-16 items-center justify-between">
        ...
        <nav className="hidden items-center gap-4 md:flex">
          ...
          <Button variant="ghost" className="relative">
            ...
            <span className="absolute -top-2 -right-2 rounded-full bg-[#000] text-[#fff] px-2 text-xs font-medium ">
              3
            </span>
          </Button>
          <Button variant="ghost" className="relative">
        ...
        <div className="flex items-center md:hidden">
          ...
          <Button variant="ghost" className="relative">
            <ShoppingCartIcon className="h-6 w-6" />
            <span className="absolute -top-2 -right-2  rounded-full bg-[#000] text-[#fff] px-2 text-xs font-medium text-primary-foreground">
              3
            </span>
          </Button>
          <Button variant="ghost" className="relative">
